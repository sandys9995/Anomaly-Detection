...
def predict_pipeline(Input_signal):
    ...
    for i in df_final_exp.index:
        ...
        defective_index= np.array(Errors_df[Errors_df['Outlier_Status']=='True'].index + 1).tolist()
    ...
    return [defective_index,faulty_dic,all_index,all_signal_dic,corr_dic,(Data_Drift_df.to_dict())]
